...
//	@When("^a user inputs a \"([^\"]*)\", \"([^\"]*)\", and clicks submit$")
//	public void a_user_inputs_a_and_clicks_submit(String username, String password) throws Throwable {
//		lp = new MercuryLogin(driver);
//		lp.loginToMercury(username, password);
//	}
	@When("^a user inputs a username, password, and clicks submit$")
	public void a_user_inputs_a_username_password_and_clicks_submit(DataTable data) throws Throwable {
